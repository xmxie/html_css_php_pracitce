  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">   
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="name" value="<?=$column['name']?>" data-validate="required:请输入标题" />         
          <div class="tips"></div>
        </div>
      </div> 
      <div class="form-group">
        ...
        <div class="field">
          <textarea type="text" class="input" name="describe" value="<?=$column['describe']?>" style="height:100px;" ></textarea>        
        </div>
     </div>
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="sequence" value="<?=$column['sequence']?>"  data-validate="required:,number:排序必须为数字" />
          <div class="tips"></div>
        </div>
      </div>
     <div class="form-group">
