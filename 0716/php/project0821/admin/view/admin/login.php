            ...
            <div class="panel loginbox">
                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group" style='margin-top:20px;'>
                        <div class="field">
                            <input type="text" class="input input-big" name="code" placeholder="填写右侧的验证码" data-validate="required:请填写右侧的验证码" style='width:40%;display: inline-block;'/>
                           <!-- <img src="images/passcode.jpg" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'">   -->
                            <input type="text" class="input input-big" disabled='disabled' value=<?=$code?>  style='width:40%;display: inline-block;'/>
                            <input type="hidden" value="<?=$code?>" name='codesys'>
                        </div>
                    </div>
                </div>
                <div style="padding:30px;"><input type="submit" class="button button-block bg-main text-big input-big" value="登录" name='up'></div>
            </div>
            </form>          
        </div>
    </div>
