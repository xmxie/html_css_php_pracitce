  ...
  <div class="body-content">
    <form method="post" class="form-x" action="" enctype="multipart/form-data">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea name="content" class="content" style="height:450px; border:1px solid #ddd;"></textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="clear"></div>
      <div class="form-group">
        ...
        <div class="field"> 
          ...
          <input type="text" class="laydate-icon input w50" name="time" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" value="<?=date("Y-m-d",time())?>"  data-validate="required:日期不能为空" style="padding:10px!important; height:auto!important;border:1px solid #ddd!important;" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
