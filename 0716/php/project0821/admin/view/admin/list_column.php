  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="add_column.php"> 添加栏目</a> </li>
					...
					for($i=0;$i<$pageSize;$i++){
						if(isset($data[$i])){
							...
							<tr>
								...
								<td>
										<a class="button border-main" href="alter_column.php?alter='.$data[$i]['id'].'"><span class="icon-edit"></span> 修改</a>
