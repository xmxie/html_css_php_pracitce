...
<div class="header bg-main">
  ...
  <div class="head-l"><a class="button button-little bg-green" href="<?=HOST_URI.'controller/content/index.php'?>" target="_blank"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;<a href="##" class="button button-little bg-blue"><span class="icon-wrench"></span> 清除缓存</a> &nbsp;&nbsp;<a class="button button-little bg-red" href="?exit=1"><span class="icon-power-off"></span> 退出登录</a> </div>
</div>
<div class="leftnav">
  ...
  <ul>
    <li><a href="list_user.php" target="right"><span class="icon-caret-right"></span>查看用户</a></li>
    <li><a href="add_user.php" target="right"><span class="icon-caret-right"></span>添加用户</a></li>
    <li><a href="book.php" target="right"><span class="icon-caret-right"></span>查看留言</a></li>
    <li><a href="list_column.php" target="right"><span class="icon-caret-right"></span>查看栏目</a></li>
    <li><a href="add_column.php" target="right"><span class="icon-caret-right"></span>添加栏目</a></li>
    <li><a href="list_content.php" target="right"><span class="icon-caret-right"></span>内容管理</a></li>
